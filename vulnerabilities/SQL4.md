...
settings.php id param
view_type.php id param
...
Affected Component: /delete_members.php and /view_type.php <br>
id parameter inside delete_members.php is vulnerable to SQL Injection
id parameter inside view_type.php is vulnerable to Cross-Site Scripting
